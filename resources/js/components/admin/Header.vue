<template>
  <header class="app-header fixed-top">
                    ...
                    <div class="item p-3">
                      ...
                      >
                        <div class="col-auto">
                          <img
                            class="profile-image"
                            :src="`${asset}admin/images/profiles/profile-1.png`"
                            alt=""
                          />
                        </div>
                        <!--//col-->
    ...
    <div
      id="app-sidepanel"
      class="app-sidepanel"
      :class="sideBarToggle ? 'sidepanel-visible' : 'sidepanel-hidden'"
    >
      ...
      <div class="sidepanel-inner d-flex flex-column">
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
          <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            <nav-link v-for="menu in menus" :key="menu" :menu="menu" />
          </ul>
        </nav>
    ...
    return {
      ...
      menus: [
        ...
        },
        {
          ...
          routeName: "newslatter",
        },
        {
          name: "Contact Message",
          iconClass: "bi bi-chat-dots",
          routeName: "contactmessage",
        },
      ],
    };
  },
